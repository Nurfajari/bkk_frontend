  ...
  return (
    <>
      <div className="text-center py-20 h-[550px] snap-start">
        <div className="m-10">
          <h1 className="font-jura font-semibold text-3xl mb-5">
            Welcome to BKK{" "}
            <span className="text-white bg-black py-1 px-3">
              SMK Negeri 1 Kota Cirebon
            </span>
          </h1>
          <p className="px-20 mb-6">
          ...
          <Button
            text="Get Started"
            className="mt-8 bg-black text-white py-1 px-5"
          ></Button>
        </div>
      </div>
      <div className="bg-black mb-5 snap-start">
