...
export default function CardLowongan()
{
    return(
        <div className="bg-white shadow-md rounded-md">
            <div className="p-2">
                <div className="p-2">
                    <img src="/Img/card_img.jpg" className="w-max h-40 object-cover rounded-md" alt="" />
                </div>
                <div className="p-2 flex justify-between items-center">
                    <div className="">
                        <h1 className="text-xl mb-2">PT Verta Logistic</h1>
                        <h1 className="text-sm text-green-500 bg-green-300/50 w-max px-[6px] rounded-md">Lowongan Buka</h1>
                    </div>
                    <div className="">
